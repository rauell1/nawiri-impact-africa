      ...
      <div className="container-site">
        ...
        >
          ...
          <p className="text-prose text-[var(--brand-text-secondary)]">
            Stay informed about our programmes, impact stories, and organisational updates.
          </p>
        </motion.div>
                ...
                <Link href={`/blog/${post.slug}`} className="block">
                  <div className="bg-white rounded-xl overflow-hidden shadow-nawiri-sm card-lift border border-[var(--border)]">
                    ...
                    <div className="p-5 md:p-6">
                      {/* Date */}
                      <p className="text-xs text-[var(--brand-text-muted)] font-ui mb-2">
                      ...
                      {/* Excerpt */}
                      {post.excerpt && (
                        <p className="text-sm text-[var(--brand-text-muted)] leading-relaxed line-clamp-3 mb-3">
                          {post.excerpt}
                        </p>
                      )}
        ...
        >
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 px-6 py-3 text-sm font-bold font-ui rounded-lg border-2 border-[var(--brand-primary)] text-[var(--brand-primary)] hover:bg-[var(--brand-primary)] hover:text-white transition-colors"
          >
